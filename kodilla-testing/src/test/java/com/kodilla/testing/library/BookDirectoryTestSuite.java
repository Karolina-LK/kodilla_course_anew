...
public class BookDirectoryTestSuite {
    ...
    public void testlListBooksInHandsOfNoBorrowedBooks() {
        ...
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        List<Book> resultListOfBooks = new ArrayList<Book>();
        //sama na to nie wpadłam, przyznaję, miałam podpowiedź od kolegi, zeby nie zapomniec o uzytkowniku:
        LibraryUser libraryUser = new LibraryUser("Iga", "Kowalska", "62150216024");
